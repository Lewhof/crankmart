  ...
  return (
    <div style={{ background: '#f5f5f5', minHeight: '100vh', padding: '32px 16px 80px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', background: '#fff', borderRadius: 12, padding: '40px 32px', border: '1px solid #ebebeb' }}>
        ...
        {[
          { h: 'Acceptance of Terms', p: 'By using CrankMart, you agree to these Terms of Service. CrankMart is a free classifieds platform connecting cyclists in South Africa. We do not facilitate payments or take commissions.' },
          ...
          { h: 'Listings', p: 'Listings must be for cycling-related items only. Listings must be accurate — no misleading descriptions or photos. Prohibited items include counterfeit goods, stolen property, and anything illegal under South African law. CrankMart reserves the right to remove any listing without notice.' },
