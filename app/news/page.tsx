  ...
  return (
    <div style={{ background: '#f5f5f5', minHeight: '100vh' }}>
      <style>{`
        ...
        .article-card{background:#fff;border-radius:12px;border:1px solid #ebebeb;overflow:hidden;text-decoration:none;color:inherit;display:flex;flex-direction:column;box-shadow:0 1px 3px rgba(0,0,0,.06);transition:box-shadow .15s,transform .15s}
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '24px 16px 0' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
            <div>
              ...
              <p style={{ margin: 0, fontSize: 14, color: '#9a9a9a' }}>Latest {adj} cycling news, race reports and industry updates</p>
            </div>
