      ...
      <div className="detail-wrapper">
          ...
          <div className="details-section">
            ...
            <div style={{ display:'flex', gap:8, paddingTop:8, flexDirection:'column' }}>
              ...
              <div style={{ display:'flex', gap:8 }}>
                {/* WhatsApp */}
                <a
                  href={`https://wa.me/?text=${encodeURIComponent(`Check out this listing on CycleMart: ${listing.title} - R${listing.price}\nhttps://cyclemart.co.za/browse/${slug}`)}`}
                  target="_blank"
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(`https://cyclemart.co.za/browse/${slug}`)
                    alert('Link copied!')
                  }}
                  style={{
                    flex: 1,
        ...
        <div className="seller-section">
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:8, padding:'0' }}>
            ...
            <div style={{ display:'flex', gap:8 }}>
              <a href={`https://wa.me/?text=${encodeURIComponent(`Check out this listing on CycleMart: ${listing.title} - R${listing.price}\nhttps://cyclemart.co.za/browse/${slug}`)}`}
              ...
              <button onClick={() => { navigator.clipboard.writeText(`https://cyclemart.co.za/browse/${slug}`); alert('Link copied!') }}
