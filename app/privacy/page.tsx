...
export const metadata = { title: 'Privacy Policy | CrankMart' }
    ...
    <div style={{ background: '#f5f5f5', minHeight: '100vh', padding: '32px 16px 80px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', background: '#fff', borderRadius: 12, padding: '40px 32px', border: '1px solid #ebebeb' }}>
        ...
        {[
          ...
          { h: 'How We Use Your Information', p: 'We use your information to operate the CrankMart marketplace, facilitate communication between buyers and sellers, send transactional emails (listing confirmations, messages), and improve our platform.' },
          ...
          { h: 'Cookies', p: 'CrankMart uses cookies for authentication and session management. We do not use third-party tracking cookies.' },
          ...
          { h: 'Contact', p: 'For privacy-related queries, contact us at privacy@crankmart.com.' },
        ].map(({ h, p }) => (
