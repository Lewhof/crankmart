      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} style={{ marginBottom: 20 }}>
            <div className="sk" style={{ height: 18, width: '100%', marginBottom: 12 }} />
            <div className="sk" style={{ height: 16, width: '98%', marginBottom: 6 }} />
            <div className="sk" style={{ height: 16, width: '95%', marginBottom: 6 }} />
            <div className="sk" style={{ height: 16, width: '92%' }} />
          </div>
        ))}
      </div>
    </div>
