...
async function main() {
  ...
  await sql`UPDATE events SET cover_image_url = 'https://crankmart.com/uploads/events/wines2whales.jpg?v=20260330' WHERE slug = 'wines2whales-mtb' OR title ILIKE '%wines2whales%' OR title ILIKE '%wine%whale%'`;
